		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Order",
									"targetURL": "#commindsetadrapapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetadrapapp-display": {
								"semanticObject": "commindsetadrapapp",
								"action": "display",
								"description": "A Sales Order Fiori application.",
								"title": "Sales Order",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.ad.rapapp",
									"url": sap.ui.require.toUrl("com/mindset/ad/rapapp")
								}
							}
						}
					}
